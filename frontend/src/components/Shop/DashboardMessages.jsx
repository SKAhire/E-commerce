...
const DashboardMessages = () => {
  ...
  useEffect(() => {
    axios
      .get(`${server}/conversation/get-all-shop-conversation/${shop._id}`, {
  ...
  return (
    <div className="w-[90%] bg-white m-5 h-[80vh] overflow-y-auto rounded">
      {!open && (
        <>
              ...
              >
                ...
                <div
                  className={`${
                    ...
                    item.sender === shopId ? "bg-purple-400" : "bg-slate-400"
                  } text-white h-min`}
                >
