    ...
    <div>
      <div className="w-full py-5">
        ...
        <p className="text-[16px] text-[#000000a6] p-[10px] flex items-center">
          {/* {data.description} */}
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Enim eius exercitationem quos assumenda distinctio fugiat esse autem quod molestiae consequatur labore voluptas natus, optio ea?
        </p>
      </div>
      <div className="p-3">
